...
function dummyHasAuthorization(req, res, next) {
  next();
}
/**
 * Expose routes
...
module.exports = function(app, passport) {
  ...
  // app.get('/articles/:id/edit', auth.comment.hasAuthorization, articles.edit);
  app.get('/articles/:id/edit', dummyHasAuthorization, articles.edit);
